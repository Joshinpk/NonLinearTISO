...
Gscale=(1/sqrt(2*pi)/Ksigma);
 [pred_RF1,alpha_RF1,mse1,ti1,npred1]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,50,50);
...
plot(m_X(8,12:noOfObservations),'LineWidth',2)
hold on
  plot(npred1(8,:),'LineWidth',2)
 hold on
