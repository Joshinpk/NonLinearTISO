...
Gscale=(1/sqrt(2*pi)/Ksigma);
 [pred_RF1,alpha_RF1,mse1,ti1,npred1]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,10,50);
...
for t = tirsoObj.order+1:nTimeInstants
    ...
    m_prediction(1:24,t)= m_predic(:,50);
      if t<3991
...
plot(m_X(21,50:noOfObservations),'LineWidth',2)
hold on
 plot(npred1(21,:),'LineWidth',2)
hold on
...
% % plot(movavg_pred(7,:))
% % hold on
 plot(m_prediction(21,:),'LineWidth',2)
