...
% [pred_RF1,alpha_RF1,mse1,ti1,npred1]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,10,step);
 [pred_RF2,alpha_RF2,mse2,ti2,npred2]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,200,step);
...
for t = tirsoObj.order+1:nTimeInstants
    ...
    m_prediction(1:14,t)= m_predic(:,5);
      if t<3991
...
plot(m_X(8,5:noOfObservations),'LineWidth',2)
hold on
