...
% [pred_RF1,alpha_RF1,mse1,ti1,npred1]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,10,step);
 [pred_RF2,alpha_RF2,mse2,mset2,ti2,npred2]=NLTISORFF(order,lamda,gamma_RF,vsigma,m_X,noOfNodes,filtOrder,noOfObservations,100,step);
...
plot(m_X(10,30:noOfObservations),'LineWidth',2)
hold on
% plot(npred1(10,:),'LineWidth',2)
hold on
plot(npred2(10,:),'LineWidth',2)
hold on
...
% % plot(movavg_pred(7,:))
% % hold on
 plot(m_prediction(10,:),'LineWidth',2)
